...
ActiveRecord::Schema[8.0].define(version: 2025_04_20_012114) do
  ...
  create_table "user_questions", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "question_id", null: false
    t.boolean "solved", default: true, null: false
    t.datetime "solved_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["question_id"], name: "index_user_questions_on_question_id"
    t.index ["user_id", "question_id"], name: "index_user_questions_on_user_id_and_question_id", unique: true

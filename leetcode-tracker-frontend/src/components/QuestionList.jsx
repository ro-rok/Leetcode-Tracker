...
// Styled card with rotating border lights on perimeter and glow pulse effect
        ...
        questions.map((q, i) => {
          ...
          return (
            <StyledCard
              ...
              className={`bg-gradient-to-br ${getDifficultyGradient(q.difficulty)} to-black/40 backdrop-blur-md transition-transform transform hover:scale-[1.05]`}
            >
